...
export const Offcanvas = ({username}) => {
    return (
        <>
            ...
            <aside id="drawer-right-example" className="fixed top-0 right-0 z-50 h-screen w-64  p-4 overflow-y-auto transition-transform translate-x-full bg-gray-800" tabIndex="-1" aria-labelledby="drawer-right-label">
